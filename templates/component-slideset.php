...
<div class="uk-slidenav-position" data-uk-slider>
  <div class="uk-slider-container">
    ...
    <?php endwhile; else: ?>
      ...
      <a><img src="<?php echo get_template_directory_uri() . '/img/placeholder_slideset_b.svg'; ?>" alt=""></a>
      <a><img src="<?php echo get_template_directory_uri() . '/img/placeholder_slideset_c.svg'; ?>" alt=""></a>
      <a><img src="<?php echo get_template_directory_uri() . '/img/placeholder_slideset_d.svg'; ?>" alt=""></a>
    <?php endif; ?>
    </div>
  </div>
